...
const HeroSectionArray = [
  { id: 1, name: 'Title', settingId: 121, value: "Every piece of Jewelry tells a story" },
  { id: 2, name: "Alignment", settingId: 122, value: "center" },
  { id: 3, name: "Font Gap Title", settingId: 123, value: "large" },
]

const HeroSection = ({ sectionId }) => {
  const settingData = useGetSettingByID(sectionId, 3); // Call the hook at the top level
  const titletext = useGetSettingByID(sectionId,1)
  return (
    ...
    <div className="flex flex-col h-[800px]" style={{ ...getdisplayhight(''),backgroundColor:useGetThemeByTag('background') }}>
      ...
      <div className="flex-1">
        ...
        <div style={{ ...getFlexStyles(useGetSettingByID(sectionId, 2)) }}
